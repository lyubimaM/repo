                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="UNCR"></asp:ListItem>
                                <asp:ListItem Value="2" Text="DSK"></asp:ListItem>
                                <asp:ListItem Value="3" Text="POST BANK"></asp:ListItem>
                                <asp:ListItem Value="4" Text="MY POS"></asp:ListItem>
                                <asp:ListItem Value="5" Text="REVOLUT"></asp:ListItem>
                            </asp:DropDownList>
